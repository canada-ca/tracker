...
import { updateUserRoleErrorType } from '../update-user-role-error'

describe('given the updateUserRoleErrorType object', () => {
  describe('testing the field definitions', () => {
    it('has an code field', () => {
      const demoType = updateUserRoleErrorType.getFields()
