  ...
  describe('users language is set to english', () => {
    ...
    describe('given a database error', () => {
      it('raises an error', async () => {
        ...
        expect(consoleErrorOutput).toEqual([
          `Database error occurred when running spfGuidanceTagLoader: Error: Database error occurred.`,
        ])
      })
    })
    describe('given a cursor error', () => {
      it('raises an error', async () => {
        ...
        expect(consoleErrorOutput).toEqual([
          `Cursor error occurred when running spfGuidanceTagLoader: Error: Cursor error occurred.`,
        ])
      })
    })
  })
