...
get_dmarc_report_detailed_tables = graphene.Field(
    ...
    domain_slug=graphene.Argument(Slug, description="The sluified version of the domain you wish to retrieve data for."),
    period=graphene.Argument(PeriodEnums, description="The period in which the returned data is relevant to."),
    year=graphene.Argument(Year, description="The year in which the returned data is relevant to."),
