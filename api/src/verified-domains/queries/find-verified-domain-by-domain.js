...
export const findVerifiedDomainByDomain = {
  ...
  resolve: async (_, args, { i18n, loaders: { loadVerifiedDomainsById }, validators: { cleanseInput } }) => {
    // Cleanse input
    ...
    if (typeof domain === 'undefined') {
      ...
      throw new Error(i18n._(t`No verified domain with the provided domain could be found.`))
    }
