...
describe('removing a domain', () => {
  ...
  describe('given a successful domain removal', () => {
    ...
    describe('users permission is super admin', () => {
      ...
      describe('domains belong to multiple orgs', () => {
        describe('domains belong to a verified check org', () => {
          beforeEach(async () => {
            ...
            it('returns a status message', async () => {
              ...
              const expectedResponse = {
                data: {
                  removeOrganizationsDomains: {
                    result: {
                      status: `Successfully removed 1 domain(s) from communications-security-establishment.`,
                    },
                  },
                },
              }
              ...
              expect(consoleOutput).toEqual([
                `User: ${user._key} successfully removed domains from org: communications-security-establishment.`,
              ])
            })
          })
