...
export const findVerifiedOrganizationBySlug = {
  ...
  resolve: async (_, args, { i18n, loaders: { loadVerifiedOrgBySlug }, validators: { cleanseInput } }) => {
    // Cleanse input
    ...
    if (typeof org === 'undefined') {
      ...
      throw new Error(i18n._(t`No verified organization with the provided slug could be found.`))
    }
