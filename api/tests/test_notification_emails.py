...
class TestPasswordReset:
    def test_email_sent_successfully(self):
        ...
        with app.test_request_context(headers=request_headers):
            ...
            assert request_headers['Origin'] in executed['data']['sendPasswordReset']['content']['body']
            assert str(request_headers['Origin'] + "/reset-password/"
                       in executed['data']['sendPasswordReset']['content']['body'])
...
class TestVerifyEmail:
    def test_email_sent_successfully(self):
        ...
        with app.test_request_context(headers=request_headers):
            ...
            # Checks that the correct URL is sent
            assert request_headers['Origin'] in executed['data']['sendValidationEmail']['content']['body']
            assert str(request_headers['Origin'] + "/verify-email/"
                       in executed['data']['sendValidationEmail']['content']['body'])
