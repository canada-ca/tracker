...
def org_perm_test_db_init():
    ...
    with app.app_context():
        ...
        domain = Domains(id=2, domain="anothercooldomain.ca", organization_id=2)
        db_session.add(domain)
        domain = Domains(id=3, domain="somelamedomain.ca", organization_id=3)
        db_session.add(domain)
        db_session.commit()
