...
async def scan_dkim(payload, client):
    ...
    task = BackgroundTask(client.post, url='http://dkim-scanner.tracker.svc.cluster.local', json=payload, headers=headers)
...
async def scan_dmarc(payload, client):
    ...
    task = BackgroundTask(client.post, url='http://dmarc-scanner.tracker.svc.cluster.local', json=payload, headers=headers)
...
async def scan_https(payload, client):
    ...
    task = BackgroundTask(client.post, url='http://https-scanner.tracker.svc.cluster.local', json=payload, headers=headers)
...
async def scan_ssl(payload, client):
    ...
    task = BackgroundTask(client.post, url='http://ssl-scanner.tracker.svc.cluster.local', json=payload, headers=headers)
...
async def manual_scan_dkim(payload, client):
    ...
    task = BackgroundTask(client.post, 'http://dkim-scanner-manual.tracker.svc.cluster.local', json=payload, headers=headers)
...
async def manual_scan_dmarc(payload, client):
    ...
    task = BackgroundTask(client.post, 'http://dmarc-scanner-manual.tracker.svc.cluster.local', json=payload, headers=headers)
...
async def manual_scan_https(payload, client):
    ...
    task = BackgroundTask(client.post, 'http://https-scanner-manual.tracker.svc.cluster.local', json=payload, headers=headers)
...
async def manual_scan_ssl(payload, client):
    ...
    task = BackgroundTask(client.post, 'http://ssl-scanner-manual.tracker.svc.cluster.local', json=payload, headers=headers)
