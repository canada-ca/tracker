...
hosts = [
    "https-scanner.tracker.example.com",
    "ssl-scanner.tracker.example.com",
    "dmarc-scanner.tracker.example.com",
]

dkim_flagged_hosts = [
    "dkim-scanner.tracker.example.com," "dmarc-scanner.tracker.example.com"
]

manual_scan_hosts = [
    "https-scanner-manual.tracker.example.com",
    "ssl-scanner-manual.tracker.example.com",
    "dmarc-scanner-manual.tracker.example.com",
]

manual_scan_dkim_flagged_hosts = [
    "dkim-scanner-manual.tracker.example.com,"
    "dmarc-scanner-manual.tracker.example.com"
]
