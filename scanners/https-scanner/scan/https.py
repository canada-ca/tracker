...
from sslyze import ScanCommand, Scanner, ServerScanRequest
from sslyze.plugins.certificate_info._certificate_utils import \
    extract_dns_subject_alternative_names

from .models import Domain
from .preload_utils import initialize_external_data
...
print(f"loading suffix list, hsts preload and pending lists.")
initialize_external_data()
print(f"lists loaded.")
...
def https_check(endpoint):
    ...
    try:
        endpoint.https_cert_chain_len = len(
            cert_plugin_result.certificate_deployments[0].received_certificate_chain
        )
