/*eslint-disable*/ module.exports = {
  messages: {
    ...
    'A-all': 'A-all',
    'A.2.3 Deploy Initial DMARC record': 'A.2.3 Deploy Initial DMARC record',
    'A.3.3 Deploy SPF for All Domains': 'A.3.3 Deploy SPF for All Domains',
    'A.3.4 Deploy DKIM for All Domains and Senders':
      'A.3.4 Deploy DKIM for All Domains and Senders',
    'A.3.5 Monitor DMARC Reports and Correct Misconfigurations':
      'A.3.5 Monitor DMARC Reports and Correct Misconfigurations',
    'A.4 Enforce': 'A.4 Enforce',
    'A.5 Maintain': 'A.5 Maintain',
    'A.5.3 Rotate DKIM Keys': 'A.5.3 Rotate DKIM Keys',
    ADMIN: 'ADMIN',
    'ALL-allow': 'ALL-allow',
    ...
    'B.2.2 Cryptographic Considerations': 'B.2.2 Cryptographic Considerations',
    'B.3.1 DMARC Records': 'B.3.1 DMARC Records',
    Back: 'Back',
    'Based in:': 'Based in:',
    ...
    'Changed TFA Send Method': 'Changed TFA Send Method',
    'Changed User Display Name': 'Changed User Display Name',
    'Changed User Email': 'Changed User Email',
    'Changed User Language': 'Changed User Language',
    'Changed User Password': 'Changed User Password',
    'Changed User Phone Number': 'Changed User Phone Number',
    'Changes Required for ITPIN Compliance':
      'Changes Required for ITPIN Compliance',
    Close: 'Close',
    'Code field must not be empty': 'Code field must not be empty',
    'Compliant TLS': 'Compliant TLS',
    Confirm: 'Confirm',
    ...
    'Domain defaults to HTTPS, but eventually redirects to HTTP':
      'Domain defaults to HTTPS, but eventually redirects to HTTP',
    'Domain does not default to HTTPS': 'Domain does not default to HTTPS',
    'Domain does not enforce HTTPS': 'Domain does not enforce HTTPS',
    'Domain not pre-loaded by HSTS': 'Domain not pre-loaded by HSTS',
    'Domain not pre-loaded by HSTS, but is pre-load ready':
      'Domain not pre-loaded by HSTS, but is pre-load ready',
    'Domain removed': 'Domain removed',
    'Domain removed from {orgSlug}': ['Domain removed from ', ['orgSlug']],
    'Domain updated': 'Domain updated',
    'Domain url field must not be empty': 'Domain url field must not be empty',
    ...
    'Edit Domain Details': 'Edit Domain Details',
    'Edit Email': 'Edit Email',
    Email: 'Email',
    'Email Configuration': 'Email Configuration',
    'Email Scan Results': 'Email Scan Results',
    ...
    'Full Fail %': 'Full Fail %',
    'Full Pass %': 'Full Pass %',
    'Fully Aligned Table': 'Fully Aligned Table',
    'Fully Aligned by IP Address': 'Fully Aligned by IP Address',
    ...
    'Lorem ipsum dolor sit amet, consectetur adipiscing elit. Praesent ac ante eu sem tincidunt dictum. In hendrerit consectetur tellus, ac.':
      'Lorem ipsum dolor sit amet, consectetur adipiscing elit. Praesent ac ante eu sem tincidunt dictum. In hendrerit consectetur tellus, ac.',
    'Maintain deployment': 'Maintain deployment',
    March: 'March',
    May: 'May',
    Menu: 'Menu',
    ...
    'No Users': 'No Users',
    'No current phone number': 'No current phone number',
    ...
    'Non-compliant TLS': 'Non-compliant TLS',
    None: 'None',
    ...
    'Policy applies to percentage of mailflow':
      'Policy applies to percentage of mailflow',
    'Pre-Alpha': 'Pre-Alpha',
    'Preloaded Status:': 'Preloaded Status:',
    Previous: 'Previous',
    Privacy: 'Privacy',
    ...
    'Public key in use for longer than 1 year':
      'Public key in use for longer than 1 year',
    'QR Code': 'QR Code',
    'RFC 4.6.4.  DNS Lookup Limits': 'RFC 4.6.4.  DNS Lookup Limits',
    'RFC 6.1.  redirect: Redirected Query':
      'RFC 6.1.  redirect: Redirected Query',
    'RFC 6.3.  General Record Format': 'RFC 6.3.  General Record Format',
    ...
    'SP-reject': 'SP-reject',
    'SPF Aligned': 'SPF Aligned',
    'SPF Domains': 'SPF Domains',
    ...
    'Save TFA Method': 'Save TFA Method',
    Scan: 'Scan',
    ...
    Users: 'Users',
    'Uses redirect tag with All': 'Uses redirect tag with All',
    ...
    'Web Scan Results': 'Web Scan Results',
    ...
    'Welcome, you are successfully signed in!':
      'Welcome, you are successfully signed in!',
    'Yearly DMARC Graph': 'Yearly DMARC Graph',
