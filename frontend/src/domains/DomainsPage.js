...
export default function DomainsPage() {
	...
	const [getAllOrgDomainStatuses, { loading: allOrgDomainStatusesLoading }] =
	...
	const [getTop25Report, { loading: top25ReportLoading }] = useLazyQuery(
		GET_TOP_25_REPORT,
		{
			variables: { filters },
			fetchPolicy: "no-cache",
	...
	<Trans>
		...
		<UnorderedList>
			...
			<ListItem>
				...
				to find domains like <strong>"example.gc.ca"</strong> or{" "}
				<strong>"example.canada.ca."</strong>
			</ListItem>
			<ListItem>
				...
				<strong>"sub.example.gc.ca"</strong> or{" "}
				<strong>"example.canada.ca."</strong>
			</ListItem>
		</UnorderedList>
