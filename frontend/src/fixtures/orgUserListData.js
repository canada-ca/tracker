  ...
  findOrganizationBySlug: {
    ...
    affiliations: {
      edges: [
        ...
        {
          node: {
            id: '27d32ab9-fdc8-4fa3-81f8-5d56b8905d0f',
        ...
        {
          node: {
            id: 'dd27d235-6028-47ba-aa52-9affcd56bc6b',
            permission: 'SUPER_ADMIN',
            user: {
        ...
        {
          node: {
            id: 'b4a647de-45df-4dbe-8058-94b1fbe71e6b',
            permission: 'USER',
            user: {
        ...
        {
          node: {
            id: '12592ee0-8605-43a0-8304-a47bd2789a57',
            permission: 'SUPER_ADMIN',
            user: {
        ...
        {
          node: {
            id: '341d48db-c212-45f5-8b08-223206583803',
            permission: 'USER',
            user: {
        ...
        {
          node: {
            id: '4fe39b04-d0f3-43b2-baea-ee6b9f9c704a',
            permission: 'ADMIN',
            user: {
        ...
        {
          node: {
            id: 'e5cdf4af-8a93-45a8-a4ec-bd5f6b81e15f',
            permission: 'USER',
            user: {
        ...
        {
          node: {
            id: 'b9435bc6-665f-4df7-90bf-62ef6d0a3a89',
            permission: 'USER',
            user: {
        ...
        {
          node: {
            id: '36c972e9-e34d-44b0-8c63-e254746a837e',
            permission: 'ADMIN',
            user: {
        ...
        {
          node: {
            id: '77636ce6-6c42-48d6-8adf-e76074260c2b',
            permission: 'SUPER_ADMIN',
            user: {
        ...
        {
          node: {
            id: '71f512a2-2e22-49fa-af32-ba1927b34156',
            permission: 'ADMIN',
            user: {
        ...
        {
          node: {
            id: '2261e5d1-08d5-46cf-8bfe-ea883a4ac35c',
            permission: 'SUPER_ADMIN',
            user: {
        ...
        {
          node: {
            id: '79e23784-c1b1-42ea-8c2e-4242801ed486',
            permission: 'ADMIN',
            user: {
        ...
        {
          node: {
            id: 'e45bb81d-400c-4d0c-b351-0d44907c4b2b',
            permission: 'ADMIN',
            user: {
        ...
        {
          node: {
            id: '71f89ad4-0274-48e1-9cad-819dc736464f',
            permission: 'USER',
            user: {
        ...
        {
          node: {
            id: 'd4d24b4f-a96b-4c75-9cc6-f228bdcdcefb',
            permission: 'USER',
            user: {
        ...
        {
          node: {
            id: '5a55595e-48b2-4c50-a355-fa5698adfeb0',
            permission: 'SUPER_ADMIN',
            user: {
        ...
        {
          node: {
            id: 'c4469a7b-4b0c-4685-832d-9831eb3f01f1',
            permission: 'USER',
            user: {
