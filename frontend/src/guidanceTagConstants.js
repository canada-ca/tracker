export const guidanceTags = {
  dmarc: {
    ...
    dmarc2: {
      ...
      ref_links_guide: 'A.2.3 Deploy Initial DMARC record',
      ref_links_technical: '',
      summary:
        'Lorem ipsum dolor sit amet, consectetur adipiscing elit. Praesent ac ante eu sem tincidunt dictum. In hendrerit consectetur tellus, ac.',
    },
    ...
    dmarc4: {
      ...
      ref_links_technical: 'RFC 6.3.  General Record Format, P',
      summary:
        'Lorem ipsum dolor sit amet, consectetur adipiscing elit. Praesent ac ante eu sem tincidunt dictum. In hendrerit consectetur tellus, ac.',
    },
    dmarc5: {
    ...
    dmarc7: {
      ...
      ref_links_guide: 'B.3.1 DMARC Records',
      ref_links_technical: 'RFC 6.3.  General Record Format, PCT',
      summary:
        'Lorem ipsum dolor sit amet, consectetur adipiscing elit. Praesent ac ante eu sem tincidunt dictum. In hendrerit consectetur tellus, ac.',
    },
    dmarc8: {
    ...
    dmarc11: {
      ...
      ref_links_guide: 'Missing from guide- need v1.1',
      ref_links_technical: '',
      summary:
        'Lorem ipsum dolor sit amet, consectetur adipiscing elit. Praesent ac ante eu sem tincidunt dictum. In hendrerit consectetur tellus, ac.',
    },
    dmarc12: {
      ...
      ref_links_technical: 'RFC 6.3.  General Record Format, RUA',
      summary:
        'Lorem ipsum dolor sit amet, consectetur adipiscing elit. Praesent ac ante eu sem tincidunt dictum. In hendrerit consectetur tellus, ac.',
    },
    dmarc13: {
      ...
      ref_links_technical: 'RFC 6.3.  General Record Format, RUF',
      summary:
        'Lorem ipsum dolor sit amet, consectetur adipiscing elit. Praesent ac ante eu sem tincidunt dictum. In hendrerit consectetur tellus, ac.',
    },
    dmarc14: {
    ...
    dmarc15: {
      ...
      ref_links_guide: 'Contact 3rd party',
      ref_links_technical: 'RFC 7.1.  Verifying External Destinations',
      summary:
        'Lorem ipsum dolor sit amet, consectetur adipiscing elit. Praesent ac ante eu sem tincidunt dictum. In hendrerit consectetur tellus, ac.',
    },
    dmarc16: {
    ...
    dmarc17: {
      ...
      ref_links_guide:
        'A.3.5 Monitor DMARC Reports and Correct Misconfigurations',
      ref_links_technical: 'RFC 6.3.  General Record Format, SP',
      summary:
        'Lorem ipsum dolor sit amet, consectetur adipiscing elit. Praesent ac ante eu sem tincidunt dictum. In hendrerit consectetur tellus, ac.',
    },
    dmarc18: {
  ...
  spf: {
    ...
    spf2: {
      ...
      guidance: 'Follow implementation guide',
      ref_links_guide: 'A.3.3 Deploy SPF for All Domains',
      ref_links_technical: '',
      summary:
        'Lorem ipsum dolor sit amet, consectetur adipiscing elit. Praesent ac ante eu sem tincidunt dictum. In hendrerit consectetur tellus, ac.',
    },
    spf3: {
      ...
      ref_links_guide: 'B.1.1 SPF Records',
      ref_links_technical: '',
      summary:
        'Lorem ipsum dolor sit amet, consectetur adipiscing elit. Praesent ac ante eu sem tincidunt dictum. In hendrerit consectetur tellus, ac.',
    },
    ...
    spf9: {
      ...
      ref_links_guide: 'link',
      ref_links_technical: 'RFC 6.1.  redirect: Redirected Query',
      summary:
        'Lorem ipsum dolor sit amet, consectetur adipiscing elit. Praesent ac ante eu sem tincidunt dictum. In hendrerit consectetur tellus, ac.',
    },
    spf10: {
    ...
    spf11: {
      ...
      ref_links_guide: 'B.1.3 DNS Lookup Limit',
      ref_links_technical: 'RFC 4.6.4.  DNS Lookup Limits',
      summary:
        'Lorem ipsum dolor sit amet, consectetur adipiscing elit. Praesent ac ante eu sem tincidunt dictum. In hendrerit consectetur tellus, ac.',
    },
  },
  ...
  dkim: {
    ...
    dkim2: {
      ...
      guidance: 'Follow implementation guide',
      ref_links_guide: 'A.3.4 Deploy DKIM for All Domains and Senders',
      ref_links_technical: '',
      summary:
        'Lorem ipsum dolor sit amet, consectetur adipiscing elit. Praesent ac ante eu sem tincidunt dictum. In hendrerit consectetur tellus, ac.',
    },
    dkim3: {
      ...
      ref_links_guide: '3.2.2 Third Parties and DKIM',
      ref_links_technical:
    ...
    dkim5: {
      ...
      ref_links_guide: 'B.2.2 Cryptographic Considerations',
      ref_links_technical: '',
      summary:
        'Lorem ipsum dolor sit amet, consectetur adipiscing elit. Praesent ac ante eu sem tincidunt dictum. In hendrerit consectetur tellus, ac.',
    },
    ...
    dkim9: {
      ...
      ref_links_guide: 'B.2.1 DKIM Records',
      ref_links_technical: '',
      summary:
        'Lorem ipsum dolor sit amet, consectetur adipiscing elit. Praesent ac ante eu sem tincidunt dictum. In hendrerit consectetur tellus, ac.',
    },
    dkim10: {
      ...
      ref_links_guide: 'A.5.3 Rotate DKIM Keys',
      ref_links_technical: '',
      summary:
        'Lorem ipsum dolor sit amet, consectetur adipiscing elit. Praesent ac ante eu sem tincidunt dictum. In hendrerit consectetur tellus, ac.',
    },
