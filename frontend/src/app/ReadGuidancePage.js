        ...
        <AccordionItem>
          ...
          <UnorderedList mb="2">
            <ListItem>
              ...
              <OrderedList>
                <ListItem>
                  <Trans>
                    The percentage of web-hosting services that strongly enforce
                    HTTPS
                  </Trans>
                </ListItem>
                <ListItem>
                  <Trans>
                    The percentage of internet-facing services that have a DMARC
                    policy of at least p=”none”
                  </Trans>
                </ListItem>
              </OrderedList>
            </ListItem>
          ...
          <UnorderedList mb="2">
            <ListItem>
              <Text>
                <Trans>
                  ...
                  admins to manage the current list and identify new domains to
                  add.
                </Trans>
              </Text>
            </ListItem>
            <ListItem>
              <Text>
                <Trans>
                  ...
                  clicking the edit button of the domain for which they wish to
                  add the selector. Common selectors to keep an for are
            ...
            <ListItem>
              <Text>
                <Trans>
                  Domains are only to be removed from your list when 1) they no
                  longer exist, meaning they are deleted from the DNS returning
                  an error code of NX DOMAIN (domain name does not exist); or 2)
                  if you have identified that they do not belong to your
                  organization.
                </Trans>
              </Text>
              <UnorderedList>
        ...
        <AccordionItem>
          ...
          <Text>
            <Trans>
              ...
              Information Technology (IT) services. The focus of the Tracker
              tool is to help organizations stay in compliance with the
              directives{' '}
              <Link
                color="blue.500"
                href={
          ...
          <OrderedList px="8" pb="8" spacing="4">
            ...
            <ListItem>
              <Trans>
                ...
                team is responsible for updating the domain and sub-domain lists
                within Tracker.
              </Trans>
            </ListItem>
            {/* 3 */}
            ...
            <ListItem>
              <Trans>
                Develop a prioritized schedule to address any failings. Consider
                prioritizing websites and web services that exchange Protected
                data.
              </Trans>
              <UnorderedList>
                <ListItem>
              ...
              <UnorderedList>
                ...
                <ListItem>
                  <Trans>
                    ...
                    can remove domains from your organization. Domains are only
                    to be removed from your list when 1) they no longer exist,
                    meaning they are deleted from the DNS returning an error
                    code of NX DOMAIN (domain name does not exist); or 2) if you
                    have identified that they do not belong to your
                    organization.
                  </Trans>
                </ListItem>
              </UnorderedList>
              ...
              <UnorderedList>
                <ListItem>
                  <Trans>
                    ...
                    specified in the Email Management Service Configuration
                    Requirements and the Web Site and Service Management
                    Configuration Requirements. For a list of allowed protocols,
                    ciphers, and curves review the ITSP.40.062 TLS guidance.
                  </Trans>
                </ListItem>
              </UnorderedList>
            </ListItem>
              ...
              <UnorderedList>
                <ListItem>
                  <Trans>
                    ...
                    “.canada.ca”. If your domain is outside that set, you need
                    to contact us to let us know. Send an email to{' '}
                    <Link
                      href="mailto:zzTBSCybers@tbs-sct.gc.ca"
                      color="blue.500"
                    >
            ...
            <ListItem>
              ...
              <UnorderedList>
                <ListItem>
                  ...
                  found in Getting Started with Tracker - Managing Your Domains.
                </ListItem>
              </UnorderedList>
            </ListItem>
            {/* 7 */}
