		...
		<Box>
			...
			<InfoPanel isOpen={isOpen} onToggle={onToggle}>
				...
				<InfoBox
					...
					info={t`Shows if the domain has a valid SSL certificate.`}
				/>
				<InfoBox
					title={t`Protocols`}
				...
				<InfoBox
					title={t`NEW`}
					info={t`Tag used to show domains as new to the system.`}
				/>
				<InfoBox
					title={t`PROD`}
					info={t`Tag used to show domains as a production environment.`}
				/>
				<InfoBox
					title={t`STAGING`}
					info={t`Tag used to show domains as a staging environment.`}
				/>
				<InfoBox
					title={t`TEST`}
					info={t`Tag used to show domains as a test environment.`}
				/>
				<InfoBox
					title={t`WEB`}
					info={t`Tag used to show domains as web-hosting.`}
				/>
				<InfoBox
					title={t`INACTIVE`}
					info={t`Tag used to show domains that are not active.`}
				/>
				<InfoBox
					title={`NXDOMAIN`}
					info={t`Tag used to show domains that have an rcode status of NXDOMAIN`}
				/>
				<InfoBox
					title={t`BLOCKED`}
					info={t`Tag used to show domains that are possibly blocked by a firewall.`}
				/>
				<InfoBox
				...
				/>
				<InfoBox
					title={t`WILDCARD ENTRY`}
					info={t`Tag used to show domains resolve to a wildcard entry.`}
				/>
				<InfoBox
					title={t`SCAN PENDING`}
					info={t`Tag used to show domains that have a pending web scan.`}
				/>
				<InfoBox
					title={t`SPIN Top 25`}
					info={t`SPIN Top 25 vulnerability detected in additional findings.`}
				/>
				<InfoBox
					title={t`Approved`}
