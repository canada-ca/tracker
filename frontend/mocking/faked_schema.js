...
export const getTypeNames = () => gql`type Query {
  ...
  findMyDmarcSummaries(
    ...
    """Filter the results based on the users affiliation."""
  ...
  """
  JSON formatted output of all domains in verified organizations that send DMARC reports.
  """
  getAllVerifiedRuaDomains: String
  ...
  """CSV formatted output of top 25 reports."""
  getTop25Reports: String
}
...
"""Keywords used to describe resources that can be modified."""
...
type Domain implements Node {
  ...
  web(
    ...
    """Exclude web scans which have pending status."""
  ...
  """Additional findings imported from an external ASM tool."""
  additionalFindings: AdditionalFinding

  """List of CVEs that have been ignored by the user."""
  ignoredCves: [CveID]
  ...
  """Value that determines if a domain is ignoring rua reports."""
  ignoreRua: Boolean

  """Value that determines if a domain is considered an asset."""
  assetState: AssetStateEnums

  """Whether or not the certificate chain contains an Entrust certificate."""
  hasEntrustCertificate: Boolean

  """
  Whether or not a CVE has been detected in the domain's additional findings.
  """
  cveDetected: Boolean
}
...
"""A field that conforms to a DKIM selector"""
scalar Selector
...
type Organization implements Node {
  ...
  """Whether the organization is externally managed."""
  ...
  """
  Historical summaries based on scan types that are preformed on the given organizations domains.
  """
  historicalSummaries(
    """The month in which the returned data is relevant to."""
    month: PeriodEnums!
...
type OrganizationSummary {
  """Date that the summary was computed."""
  date: Date
...
enum filterValueEnums {
  ...
  """Label for tagging domains that have an Entrust certificate."""
  HAS_ENTRUST_CERTIFICATE

  """Label for tagging domains that have vulnerabilities."""
  CVE_DETECTED

  """An asset confirmed to belong to the organization."""
  APPROVED

  """
  An asset that is owned by a third party and supports the operation of organization-owned assets.
  """
  DEPENDENCY

  """
  An asset that is relevant to the organization but is not a direct part of the attack surface.
  """
  MONITOR_ONLY

  """
  An asset that is suspected to belong to the organization but has not been confirmed.
  """
  CANDIDATE

  """
  An asset that requires further investigation to determine its relationship to the organization.
  """
...
type TLSResult {
  ...
  """
  The compliance status of the certificate bundle for the scanned server from this scan.
  """
...
"""A finding imported from an external ASM tool."""
type AdditionalFinding {
  """The date the finding was discovered."""
  timestamp: DateTime

  """The locations the finding was discovered."""
  locations: [WebComponentLocation]

  """The ports the finding was discovered."""
  ports: [WebComponentPort]

  """The headers the finding was discovered."""
  headers: [String]

  """The web components the finding was discovered."""
  webComponents: [WebConnectionType]

  """The vulnerabilities the finding was discovered."""
  vulnerabilities: Vulnerabilites
}

type WebComponentLocation {
...
type WebComponentPort {
  """The port the finding was discovered."""
  port: String

  """The protocol the finding was discovered."""
  lastPortState: String

  """The date the finding was discovered."""
  portStateFirstSeen: String

  """The date the finding was discovered."""
  portStateLastSeen: String
}
...
type WebConnectionType {
  ...
  """The status of the web component."""
  webComponentVersion: String

  """"""
  webComponentCves: [WebComponentCVE]

  """"""
  webComponentPorts: [WebComponentPort]

  """"""
  webComponentFirstSeen: String

  """"""
  webComponentLastSeen: String
}

type WebComponentCVE {
...
type Vulnerabilites {
  ...
  critical: [WebComponentCVE]

  """The criticality of the finding."""
  high: [WebComponentCVE]

  """The criticality of the finding."""
  medium: [WebComponentCVE]

  """The criticality of the finding."""
  low: [WebComponentCVE]
}

"""String that conforms to a CVE ID structure."""
scalar CveID
...
"""
An enum used to describe how an asset relates to an organization's attack surface.
"""
enum AssetStateEnums {
  """An asset confirmed to belong to the organization."""
  APPROVED
...
type DkimFailureTable {
  ...
  guidance: String @deprecated(reason: "This has been turned into the 'guidanceTag' field providing detailed information to act upon if a given tag is present.")
...
"""A connection to a list of items."""
type ChartSummaryConnection {
  """Information to aid in pagination."""
  pageInfo: PageInfo!

  """A list of edges."""
  edges: [ChartSummaryEdge]
...
type Mutation {
  ...
  addOrganizationsDomains(input: AddOrganizationsDomainsInput!): AddOrganizationsDomainsPayload
  ...
  """Ignore a CVE for a domain."""
  ignoreCve(input: IgnoreCveInput!): IgnoreCvePayload
  ...
  """Unignore a CVE for a domain."""
  unignoreCve(input: UnignoreCveInput!): UnignoreCvePayload
...
type AddOrganizationsDomainsPayload {
  """
  'BulkModifyDomainsUnion' returning either a 'DomainBulkResult', or 'DomainErrorType' object.
  """
  result: BulkModifyDomainsUnion
  clientMutationId: String
}

"""
This union is used with the 'AddOrganizationsDomains' and 'RemoveOrganizationsDomains' mutation, 
                allowing for users to add/remove multiple domains belonging to their org, 
                and support any errors that may occur
"""
union BulkModifyDomainsUnion = DomainError | DomainBulkResult
...
type DomainBulkResult {
  """Informs the user if the domain mutation was successful."""
  status: String
}

input AddOrganizationsDomainsInput {
...
input CreateDomainInput {
  ...
  """Value that determines how the domain relates to the organization."""
  assetState: AssetStateEnums!
  clientMutationId: String
}
...
type IgnoreCvePayload {
  """'IgnoreCveUnion' returning either a 'Domain' or an error"""
  result: IgnoreCveUnion
  clientMutationId: String
}

"""
This union is used with the 'IgnoreCve' mutation,
allowing for users to ignore a CVE for a domain and support any errors that may occur
"""
union IgnoreCveUnion = DomainError | Domain

input IgnoreCveInput {
  """The global id of the domain which is ignoring the CVE."""
  domainId: ID!

  """The CVE ID that is being ignored."""
  ignoredCve: CveID
  clientMutationId: String
}
...
type RemoveOrganizationsDomainsPayload {
  """
  'BulkModifyDomainsUnion' returning either a 'DomainBulkResult', or 'DomainErrorType' object.
  """
  result: BulkModifyDomainsUnion!
...
input RemoveOrganizationsDomainsInput {
  """Domains you wish to remove from the organization."""
  domains: [DomainScalar]!

  """The organization you wish to remove the domain from."""
  orgId: ID!

  """Domains will be archived."""
...
type UnignoreCvePayload {
  """'IgnoreCveUnion' returning either a 'Domain' or an error"""
  result: IgnoreCveUnion
  clientMutationId: String
}

input UnignoreCveInput {
  """The global id of the domain which is unignoring the CVE."""
  domainId: ID!
...
input UpdateDomainInput {
  ...
  """Boolean value that determines if the domain should ignore rua reports."""
  ignoreRua: Boolean

  """Value that determines how the domain relates to the organization."""
  assetState: AssetStateEnums

  """List of CVEs that the user has chosen to ignore."""
  ignoredCves: [CveID]
  clientMutationId: String
}
...
input UpdateOrganizationInput {
  ...
  """If the organization has domains that are managed externally."""
  externallyManaged: Boolean
  clientMutationId: String
}
...
type SignUpPayload {
  """
  'SignUpUnion' returning either a 'TFASignInResult', or 'SignUpError' object.
  """
  result: SignUpUnion
  clientMutationId: String
}
